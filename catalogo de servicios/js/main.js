...
function creaNuevaDB(tx){
	...
	tx.executeSql("INSERT INTO agenda_curso (id,nombre,imagen,telefono,e-mail,domicilio,categoria,nota) VALUES (1,'cristian','','+04466552148','cristian@hotmail.com','centro','altaservicio','catalogo de servicio')");
}
...
function cargaDatosSuccess(tx, results){
	...
	for(var i=0; i<results.rows.length; i++){
		...
		selector.append('<li id="li_'+persona.id+'"><a href="#detalle" data-uid='+persona.id+' class="linkDetalles"><div class="interior_lista"><img src="'+ foto +'" class="img_peq"/><span>' + persona.nombre + ' ' + persona.apellidos+ '</span></div></a><a href="#page3"  data-theme="e" data-uid='+persona.id+'  class="linkForm">Predet.</a></li>').listview('refresh');
	}
...
$(document).on('pagebeforeshow', '#pag3', function(){ 
	mkLog('ID recuperado en vista alta registro: ' + $.id);
